...
import { ClientDto } from 'src/web-api/client/dto/client.dto';
...
export class AppointmentResponseDto {
    ...
    @ApiProperty({ description: 'Appointment start date', type: Date, nullable: true })
    appointmentStartDate: Date | null;

    @ApiProperty({ description: 'Appointment end date', type: Date, nullable: true })
    ...
    @ApiProperty({ description: 'Personal observation (informacoes pessoais)', type: String })
